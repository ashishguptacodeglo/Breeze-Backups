...
@Component({
  selector: 'app-currently-hosting',
  templateUrl: './currently-hosting.component.html',
  styleUrls: ['./currently-hosting.component.scss']
})
export class CurrentlyHostingComponent implements OnInit {
