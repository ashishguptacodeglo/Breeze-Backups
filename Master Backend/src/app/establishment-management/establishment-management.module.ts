...
import { EstablishmentManagementRoutingModule } from './establishment-management-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    EstablishmentManagementRoutingModule,
    MenuModule,
...
export class EstablishmentManagementModule { }
